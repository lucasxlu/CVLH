...
public class AnimalsClassificationTest {
    protected static final Logger log = LoggerFactory.getLogger(AnimalsClassificationTest.class);
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
    ...
    public static void main(String[] args) throws Exception {
        new AnimalsClassificationTest().run(args);
    }
